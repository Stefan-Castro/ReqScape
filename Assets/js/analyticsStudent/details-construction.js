const TableIntentosModule = {
    config: {
        ...
        detailsEndpoint: `${base_url}/AnalyticsStudent/get_detalles_intento_construction`,
    },
...
const DashboardModule = {
    ...
    config: {
        ...
        endpoint: `${base_url}/AnalyticsStudent/get_intentos_jugador_construction`,
    },
...
const ReportModule = {
    ...
    async downloadReport() {
        ...
        const url = `${base_url}/AnalyticsStudent/downloadReportConstruction?gamecode=${encodeURIComponent(gameCode)}`;
