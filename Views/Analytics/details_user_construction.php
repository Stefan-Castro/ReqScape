        ...
        <div class="analyse player-dashboard">
            ...
            <div class="player-stats">
                <div class="card-item li">
                    ...
                    <span class="info">
                        <div class="title-wrapper">
                            <p class="analyse-title" data-i18n="details_construction.stats.time.title">Tiempo</p>
                ...
                <div class="card-item li">
                    ...
                    <span class="info">
                        <div class="title-wrapper">
                            <p class="analyse-title" data-i18n="details_construction.stats.attempts.title">Número Intentos</p>
        ...
        <div class="bottom-data">
            <div class="orders">
                <div class="header-table">
                    ...
                    <h3 data-i18n="details_construction.table.title">Intentos</h3>
                </div>
                <table id="tableIntentos" class="table-players nowrap">
                    <thead>
                        <tr>
                            ...
                            <th>Fragmentos Correctos</th>
                            <th>Fragmentos Incorrectos</th>
                            <th>Señuelos Usados</th>
