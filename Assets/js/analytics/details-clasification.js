const TableIntentosModule = {
    config: {
        ...
        detailsEndpoint: `${base_url}/Analytics/get_detalles_intento`
    },
...
const DashboardModule = {
    ...
    config: {
        ...
        endpoint: `${base_url}/Analytics/get_intentos_jugador`,
    },
...
const ReportModule = {
    ...
    async downloadReport() {
        ...
        const url = `${base_url}/Analytics/downloadReportClass?gamecode=${encodeURIComponent(gameCode)}&Jugador=${encodeURIComponent(player)}`;
